      ...
      <div class="col-md-8 order-md-1">
        <h4 class="mb-3">Billing address</h4>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="streetAddress" name="streetAddress" placeholder="1234 Main St" >
            <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" id="postalCode" name="postalCode" placeholder="1234">
              <div class="invalid-feedback">
              Zip code required.
              </div>
            </div>
            ...
            <div class="col-md-9 mb-3">
              ...
              <input type="text" class="form-control" id="city" name="city" placeholder="Copenhagen" >
              <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="phone" name="phone" placeholder="12 34 56 78" >
            <div class="invalid-feedback">
