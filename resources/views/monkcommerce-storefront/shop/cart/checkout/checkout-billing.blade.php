...
<div class="pt-4 mx-5">
  <h3>Checkout</h3>
  @include('monkcommerce::monkcommerce-storefront.shop.cart.checkout.partials._checkout-steps', ['step2' => FALSE])
  <hr/>
  ...
  <form action="{{ route('monk-shop-checkout-billing-post') }}" method="post" id="checkout-form">
    ...
    <h5 class="mb-3">Billing Address</h5>
      ...
      <!-- Buttons -->
      <div class="row d-flex justify-content-between border-top pt-4">
        <div class="col-md-4">
