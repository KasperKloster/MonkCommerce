  ...
  <div class="col-md-1"></div>
    <div class="col">
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        <a href="{{ route('categories.edit', $childCategory->id) }}" class="btn btn-sm btn-info mat-inline-center"><i class="material-icons">edit</i>{{ ucwords(__('monkcommerce-dashboard.general-words.edit')) }}</a>
        <a href="{{ route('categories.create', ['parentCat' => $childCategory->id])}}" class="btn btn-sm btn-success mat-inline-center"><i class="material-icons">add</i> {{ ucwords(__('monkcommerce-dashboard.categories.create_subcategory')) }}</a>
