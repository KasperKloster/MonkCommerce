  ...
  <div class="col-md-1"></div>
    <div class="col">
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        ...
        <a href="{{ route('monk-admin-destroy-category', $childCategory->id) }}" class="btn btn-sm btn-danger"><i class="material-icons">delete_forever</i> {{ ucwords(__('monkcommerce-dashboard.general-words.delete')) }}</a>
      </div>
      </li>
  </div>
</div>
