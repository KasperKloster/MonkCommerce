  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="pageName" name="pageName" aria-describedby="pageNameHelpBlock" placeholder="{{ ucwords(__('monkcommerce-dashboard.pages.page_name')) }}" required>
