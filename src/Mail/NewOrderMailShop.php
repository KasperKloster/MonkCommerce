...
class NewOrderMailShop extends Mailable
{
  ...
  public function build()
  {
    ...
    return $this->markdown('monkcommerce::emails.orders.new-order-shop')
                ->from($store->email, $store->shop_name)
                ->subject($store->shop_name . ' | New Order! Order ID: ' . $this->order->id);
  }
}
